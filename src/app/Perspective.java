...
public class Perspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout leftFolder = layout.createFolder("leftFolderLayout",IPageLayout.LEFT, 0.10f, editorArea);
		...
		IFolderLayout mainfolder = layout.createFolder("mainfolder", IPageLayout.RIGHT, 0.75f, editorArea);
		mainfolder.addView("BIT_DEC.functionsView");
		mainfolder.addView("BIT_DEC.callgraphView");
		
		IFolderLayout srcfolder = layout.createFolder("srcfolder", IPageLayout.RIGHT, 0.45f, editorArea);
